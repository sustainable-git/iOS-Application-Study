...
class CardView: UIView { // 31 x 44 크기
    ...
    func initialize(shape: Shape, number: Number, shade: Shade, color: Color) {
        self.shape = shape
        self.number = number
        self.shade = shade
        self.color = color
    ...
    private func drawContent(rect : CGRect, shape : Shape, color : Color, shade : Shade) {
        ...
        switch shape {
        case Shape.oval : path = shapeOval(rect: rect)
        case Shape.diamond : path = shapeDiamond(rect: rect)
        case Shape.squiggle : path = shapeSquiggle(rect: rect)
        }
        
        switch color {
        case Color.red :    UIColor.init(cgColor: #colorLiteral(red: 1, green: 0.231372549, blue: 0.1882352941, alpha: 1)).setFill()
                            UIColor.init(cgColor: #colorLiteral(red: 1, green: 0.231372549, blue: 0.1882352941, alpha: 1)).setStroke()
        case Color.green :  UIColor.init(cgColor: #colorLiteral(red: 0.1568627451, green: 0.8039215686, blue: 0.2549019608, alpha: 1)).setFill()
                            UIColor.init(cgColor: #colorLiteral(red: 0.1568627451, green: 0.8039215686, blue: 0.2549019608, alpha: 1)).setStroke()
        case Color.blue :   UIColor.init(cgColor: #colorLiteral(red: 0, green: 0.4784313725, blue: 1, alpha: 1)).setFill()
